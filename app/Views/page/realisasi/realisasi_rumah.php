...
<body>
        ...
        <div class="nav1">
          ...
          <div class="menu-dropdown">
            ...
            <div class="dropdown-container">
              ...
              <a class="menu-link active" href="/realisasi-rumah">
               ...
               <select name="perumahan_id" class="form-control" required>
                  ...
                  ?>
                      <option value="<?= $item['id']; ?>"
                          ...
                          <?= $item['kode_rumah']; ?> 
                          <?= $item['kode_rab'] ? ' | RAB: '.$item['kode_rab'] : ' | RAB: -'; ?>
                          <?= $isUsed ? '(Sudah ada Realisasi)' : '' ?>
                      </option>
                  <?php endforeach; ?>
              </select>
              </div>
              <div class="mb-3">
                <label for="sub_total_asli" class="form-label">Total Anggaran</label>
                <input type="number" class="form-control" name="sub_total_asli" required>
              </div>
              <div class="mb-3">
                <label for="tanggal_mulai" class="form-label">Tanggal Mulai Pembangunan</label>
                <input type="date" class="form-control" name="tanggal_mulai" required>
              </div>
              <div class="mb-3">
                <label for="tanggal_selesai" class="form-label">Tanggal Selesai Pembangunan</label>
  ...
  <script src="<?= base_url('assets/js/realisasirumah.js') ?>"></script>
