...
<body>
          ...
          <div class="menu-dropdown">
            ...
            <div class="dropdown-container">
              ...
              <a class="menu-link" href="/realisasi-bahan">
               ...
               <a class="menu-link active" href="/realisasi-pekerja">
        ...
        <div class="modal-content">
          ...
          <form onsubmit="event.preventDefault(); simpanForm();">
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label for="realisasi_id" class="form-label">Pilih Rumah (Realisasi)</label>
                <select name="realisasi_id" class="form-control" required>
                  <option value="">-- Pilih Rumah --</option>
                  <?php foreach ($realisasiRumah as $item): 
                      $isUsed = in_array($item['realisasi_id'], $usedIds); 
                  ?>
                      <option value="<?= $item['realisasi_id']; ?>"
                          style="<?= $isUsed ? 'background-color:#28a745; color:white;' : '' ?>">
                          <?= $item['kode_rumah']; ?>
                          <?= $item['kode_rab'] ? ' | RAB: '.$item['kode_rab'] : ' | RAB: -'; ?>
                          <?= $isUsed ? '(Sudah ada Pekerja)' : '' ?>
                      </option>
                  <?php endforeach; ?>
                </select>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="biaya_kontraktor" required>
              </div>
            </div>
  ...
  <script src="<?= base_url('assets/js/realisasipekerja.js') ?>"></script>
